...
class _FormWidgetState extends State<Uas> {
  TextEditingController nameController =
      TextEditingController(text: 'EkaZakaria');
  ...
  TextEditingController tanggalLahirController =
      TextEditingController(text: '02Desember2003');
  File? photo;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Input Biodata',
          style: TextStyle(
            color: Color.fromARGB(255, 152, 156, 152),
            fontWeight: FontWeight.bold,
          ),
        ),
        elevation: 3,
        backgroundColor: Color.fromARGB(255, 9, 12, 214),
        actions: const [
          Icon(
            Icons.logout,
            color: Colors.white,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(255, 234, 23, 4),
